...
// Initialize the Nodemailer transporter using your Gmail credentials
const transporter = nodemailer.createTransport({
  service: "gmail",
  auth: {
    user: process.env.EMAIL_USER, // Your personal Gmail address
...
export async function sendPriceDropAlert(
  ...
  try {
    ...
    // Nodemailer uses sendMail instead of emails.send
    ...
    // Nodemailer throws an error if it fails, so we just return the messageId on success
